...
;(function (factory) {
    ...
    editormd.prototype = editormd.fn = {
                ...
                $.post('/?rest_route=/githuber/convert', {'text': cmValue}, function (data, resp) {
                    ...
                    if (settings.toc) {
                        var tocContainer = "" === settings.tocContainer ? previewContainer : $(settings.tocContainer)
                            , tocMenu = tocContainer.find("." + this.classPrefix + "toc-menu");
                        tocContainer.attr("previewContainer", "" === settings.tocContainer ? "true" : "false"),
                        "" !== settings.tocContainer && tocMenu.length > 0 && tocMenu.remove(),
                            editormd.markdownToCRenderer(markdownToC, tocContainer, settings.tocDropdown, settings.tocStartLevel),
                        (settings.tocDropdown || tocContainer.find("." + this.classPrefix + "toc-menu").length > 0) && editormd.tocDropdownMenu(tocContainer, "" !== settings.tocTitle ? settings.tocTitle : this.lang.tocTitle),
                        "" !== settings.tocContainer && previewContainer.find(".markdown-toc").css("border", "none")
                    }
                    settings.tex && (!editormd.kaTeXLoaded && settings.autoLoadModules ? editormd.loadKaTeX(function () {
                        editormd.$katex = katex,
                    ...
                    state.loaded && $.proxy(settings.onchange, this)()
                });
            }
        ...
        //             };
        //
        //             var inlinePrefix = global_editormd_config.texInlinePrefix,
        //                 displayPrefix = global_editormd_config.texDisplayPrefix;
        //             previewContainer.find("*").each(function (index, node) {
        ...
        //                         {
        //                             var text = node.childNodes[i].innerHTML;
        //                             if(text)
        //                             {
        ...
        markedRenderer.paragraph = function (text) {
            ...
            if (isToC) {
                ...
                if (pageBreakReg.test(text)) {
                    ...
                    return "<p>" + this.atLink(this.emoji(text)) + "</p>\n";
                }
            }
        };
